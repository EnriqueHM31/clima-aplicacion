...
export default function ContenedorScrollAnimado({ children }: ContenedorScrollAnimadoProps) {
    return (
        <motion.div
            ...
            className="scroll-estilado relative mx-auto h-48 max-w-4xl overflow-x-auto overflow-y-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950"
        >
